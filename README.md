...
The code in this repository is released under the [MIT](https://github.com/Lonelypheonix/Lonelypheonix.github.io/blob/main/MIT.md) License, which grants you the freedom to use, modify, and distribute the template as your own. However, if you choose to use the site's design largely unmodified, kindly credit me as the original designer of the site.
...
- Click [here]([https://shaq-portfolio.netlify.app/](https://lonelypheonix.github.io/)) to view the live demo.
...
```
cd Lonelypheonix.github.io && code .
```
